...
- (void)setupLayoutConstraints {
    ...
    [self.captionView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(10)-[captionLabel]-(0)-[pageControl]-(8)-|" options:0 metrics:metrics views:views]];
